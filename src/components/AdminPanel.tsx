    ...
    return (
        ...
        >
            ...
            <div className="w-full flex flex-col gap-1 lg:w-1/2 text-left">
                ...
                <p className="text-black text-base font-normal lg:w-4/5">"Manage user roles, registration flows, content schedules, comms, booth zones, analytics, and more — all from one powerful dashboard. Granular access permissions included."</p>
